...
Set-ItemProperty -Path $SearchPolicyPath -Name "DisableSearchBoxSuggestions" -Value 1 -ErrorAction SilentlyContinue
...
Set-ItemProperty -Path $CopilotPolicyPath -Name "TurnOffWindowsCopilot" -Value 1 -ErrorAction SilentlyContinue
